      ...
      <div className="w-full max-w-md relative z-10">
        <GlowCard className="p-6 md:p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-[#8B8B9E] text-sm">Sign in to save stats and generate proposals.</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="btn-teal w-full py-3.5 rounded-xl text-sm font-bold flex items-center justify-center gap-2 mt-2 disabled:opacity-70 disabled:cursor-not-allowed"
            >
          ...
          <p className="text-center text-[#8B8B9E] text-sm mt-8">
            ...
            <Link href={`/signup?redirect=${encodeURIComponent(redirect)}`} className="text-[#00F5C4] hover:underline font-medium">
              Sign up
            </Link>
          </p>
        </GlowCard>
